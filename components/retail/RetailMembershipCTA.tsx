...
export function RetailMembershipCTA() {
  return (
    <section className="relative overflow-hidden bg-[#0f2318] px-6 py-20 sm:px-10 lg:px-16">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        >
          Shopping is just the start.{" "}
          <span className="italic text-[#e0a33e]">Make it a ritual.</span>
        </motion.h2>
        ...
        >
          DrGreenClub membership brings the same curation you see in retail
          into a recurring experience, on a cadence you choose. Explore the
          plans to see what fits your routine.
        </motion.p>
...
export default RetailMembershipCTA;