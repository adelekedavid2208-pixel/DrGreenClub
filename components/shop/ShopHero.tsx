    ...
    <section className="relative overflow-hidden bg-[#0f2318] px-6 pb-20 pt-14 sm:px-10 lg:px-16">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 lg:grid-cols-2 lg:gap-10">
        ...
        <div>
          ...
          >
            Premium{" "}
            <span className="italic text-[#e0a33e]">Cannabis Collection.</span>
          </motion.h1>
          ...
          >
            Explore our full range of glass, vaporizers, apparel, and
            accessories — each piece curated to the same standard, whether
            you're shopping once or every month.
          </motion.p>
        ...
        >
          <Image
            ...
            alt="DrGreenClub premium cannabis product collection"
            fill
            priority
