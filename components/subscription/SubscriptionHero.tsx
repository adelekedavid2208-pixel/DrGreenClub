    ...
    <section className="relative overflow-hidden bg-[#0f2318] px-6 pb-20 pt-14 sm:px-10 lg:px-16">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 lg:grid-cols-2 lg:gap-10">
        ...
        <div>
          ...
          >
            A ritual worth{" "}
            <span className="italic text-[#e0a33e]">looking forward to.</span>
          </motion.h1>
          ...
          >
            ...
            your door on a cadence you choose. Compare plans to find the one
            that fits.
          </motion.p>
        ...
        >
          <Image
            ...
            alt="DrGreenClub membership box contents"
            fill
            priority
